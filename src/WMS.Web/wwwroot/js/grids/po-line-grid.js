/* ==================================================================
   ...
   Composes with wmsfFormState via Object.assign:
     ...
     <form x-data="Object.assign(wmsfFormState({...}), poLineGrid({...}))">
...
function poLineGrid(opts) {
    ...
    return {
        ...
        linesDotClass() {
            ...
            if (this.lines.some(l => l.productId || l.lotNumber)) return 'is-progress';
            return '';
        },
        ...
        _renumberDisplayOrder() {
            this.lines.forEach((l, i) => { l.displayOrder = (i + 1) * 10; });
        },
